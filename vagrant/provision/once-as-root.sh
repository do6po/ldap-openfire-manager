...
mysql -uroot -proot <<< "CREATE DATABASE ldap_openfire_manager CHARACTER SET utf8 COLLATE utf8_unicode_ci;"
mysql -uroot -proot <<< "CREATE DATABASE ldap_openfire_manager_tests CHARACTER SET utf8 COLLATE utf8_unicode_ci;"
echo "Done!"
